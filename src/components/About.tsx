...
const About = () => {
  ...
  const skills = [
    { icon: Globe, name: 'HTML5', level: 95 },
    { icon: Code, name: 'JavaScript', level: 34 },
    { icon: Code, name: 'Java', level: 79 },
    { icon: Lightning, name: 'Python', level: 95 },
    { icon: Code, name: 'C', level: 90 },
    { icon: Cube, name: 'Bootstrap', level: 91 },
    { icon: Rocket, name: 'UI/UX Design', level: 88 },
    { icon: Rocket, name: 'CSS3', level: 86 },
    { icon: Heart, name: '', level: 0 },
    { icon: Database, name: 'MongoDB', level: 26 },
    { icon: GitBranch, name: 'Git', level: 77 },
    { icon: Cube, name: 'GitHub', level: 83 },
    { icon: Terminal, name: 'Bash', level: 85 },
  ];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-80 h-80 mx-auto lg:mx-0">
              ...
              <div className="relative w-full h-full glass rounded-full p-2 hover:shadow-glow-primary transition-all duration-500 group">
                <div className="w-full h-full cursor-pointer rounded-full overflow-hidden bg-gradient-secondary">
                  <img src="/Images/profileLogo.jpg" alt="Sanjay Ravi - Full Stack Developer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
              </div>
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I'm an Animated Website Developer specializing in crafting visually engaging, interactive, and high-performance web experiences. I focus on creating smooth animations and dynamic user interfaces using React.js, modern JavaScript, and CSS animations. My work emphasizes responsive design, seamless user interactions, and optimized performance, with complete deployment workflows managed using Git and Docker.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-secondary-glow font-medium">1</span>
                <span className="text-muted-foreground ml-1">Project</span>
              </div>
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-accent-glow font-medium">100%</span>
                <span className="text-muted-foreground ml-1">Client Satisfaction Assured</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {skills.filter(skill => skill.name && skill.name.trim() !== '').map((skill, index) => (
              <div key={`${skill.name}-${index}`} className="glass p-6 cursor-pointer rounded-xl hover:shadow-glow-primary transition-all duration-300 hover:scale-105 group">
